...
// export const load: PageLoad = async ({ fetch, params })  => {
//   const response = await fetch(`http://127.0.0.1:8000/catalog/game/${params.gameid}/`)
//   const response_dev = await fetch(`http://127.0.0.1:8000/catalog/company/${params.developersid}/`)
//   const response_genres = await fetch(`http://127.0.0.1:8000/catalog/genre/${params.genreid}/`)
//   if (response.ok){
//     const games = await response.json()
//     const genres = await response_genres.json()
//     const developers = await response_dev.json()
//     let genre_id = params.genreid
//     let dev_id = params.developersid
//     return {
//       games, genres, developers, genre_id, dev_id 
//     }
//   }
//   else{
//     throw error(404, 'Не найдено');
