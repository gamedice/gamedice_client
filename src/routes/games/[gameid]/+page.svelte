...
<div class="mb-12">
  <div class="flex flex-row justify-between">
    <h1 class="ml-20 text-5xl font-bold tracking-tight text-gray-900 dark:text-white game-name">
      {games.name}
    </h1>
    <a class=" mr-20" href="/">
  ...
  <div class="flex flex-row mx-20 mt-12">
    <img src={games.photo} class="w-96 h-full object-cover float-left" alt="Обложка игры" />
